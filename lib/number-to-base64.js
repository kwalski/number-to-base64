(function (global, factory) {
  ...
  var setRadix64 = function setRadix64(radix) {
    if (radix.length !== 64) {
  ...
  var bton = function bton(base64) {
    ...
    for (var _i2 = sign; _i2 < base64.length; _i2++) {
      number = number * 64 + s2b[base64.charCodeAt(_i2)];
    }

    return sign ? -number : number;
  };

  exports.default = { ntob: ntob, bton: bton, setRadix64: setRadix64 };
